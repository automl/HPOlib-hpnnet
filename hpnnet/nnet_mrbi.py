...
def main(params, **kwargs):
    ...
    y = bergstra_2011_helper.wrapping_nnet_split_decorator(params, space, protocol_class, **kwargs)
    print 'Result: ', y
    return y
...
def run_test(params, **kwargs):
    ...
    print 'Params: ', params, '\n'
    space = hpnnet.nips2011.nnet1_preproc_space()
    y = bergstra_2011_helper.wrapping_nnet_split_decorator(params, space, protocol_class, 'test', **kwargs)
    print 'Result: ', y
    return y
